...
export default function LoginScreen() {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      await login(values);
      // Root index.tsx will redirect to (tabs)/card once status flips to signedIn.
    } catch (error) {
      ...
      >
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          <View style={[styles.iconBadge, { backgroundColor: theme.colors.primaryContainer }]}>
            <Icon source="card-account-details-outline" size={36} color={theme.colors.primary} />
          </View>
          ...
          >
            Sign in to share your digital card and manage your connections.
          </Text>
